...
app.get('/api/health', (req, res) => res.json({ ok: true, build: '35.4', mediaPolish: true, mp3Artwork: true, contextualToolbar: true, xstatusMarquee: true, xstatusPhrases: true, presenceFix: true, countryFlags: true, compactChatHeader: true, cleanCountryHeader: true }));
